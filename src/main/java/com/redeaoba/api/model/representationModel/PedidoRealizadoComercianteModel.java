...
public class PedidoRealizadoComercianteModel {
    ...
    public static PedidoRealizadoComercianteModel toModel(Pedido pedido){
        PedidoRealizadoComercianteModel model = new PedidoRealizadoComercianteModel();
    ...
    public static List<PedidoRealizadoComercianteModel> toModel(List<Pedido> pedidos){
        List<PedidoRealizadoComercianteModel> models = new ArrayList<>();
        pedidos.forEach(p -> models.add(PedidoRealizadoComercianteModel.toModel(p)));
